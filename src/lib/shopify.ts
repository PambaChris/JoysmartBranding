...
export const SHOPIFY_STORE_PERMANENT_DOMAIN = "joy-spark-branding-xjswl.myshopify.com";
export const SHOPIFY_STOREFRONT_URL = `https://${SHOPIFY_STORE_PERMANENT_DOMAIN}/api/${SHOPIFY_API_VERSION}/graphql.json`;
export const SHOPIFY_STOREFRONT_TOKEN = "a4189a7552ff84ae93b1bf15f126b5a1";
